      ...
      <div>
        ...
        <Paper style={styles.searchField}>
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField {...params} variant='outlined' label='Tesla' placeholder='GameStop...' />
            )}
          />
        </Paper>
      </div>
      <div style={styles.graphContainer}>
        <AreaChart width={480} height={300} data={graph1} margin={{ top: 10, right: 30 }}>
        ...
        <AreaChart width={480} height={300} data={graph2} margin={{ top: 10, right: 30 }}>
          <CartesianGrid strokeDasharray='3' />
          <defs>
            <linearGradient id='gain' x1='0' y1='0' x2='0' y2='1'>
